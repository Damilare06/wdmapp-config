...
class Wdmapp(BundlePackage):
    ...
    variant('externalCoupler', default=False,
    ...
    depends_on('gene@wdmapp-0.1.0 +effis', when='~externalCoupler +effis')
    depends_on('xgc-devel@wdmapp-0.1.0 +effis', when='~externalCoupler +effis')
